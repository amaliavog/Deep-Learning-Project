...
class ProteinBertConfig(ProteinConfig):
    ...
    def __init__(self,
                 vocab_size: int = 30,
                 hidden_size: int = 32, #hidden_size: int = 768,
                 num_hidden_layers: int = 3, # num_hidden_layers: int = 12,
                 num_attention_heads: int = 8, # num_attention_heads: int = 12,
                 intermediate_size: int = 64, # intermediate_size: int = 3072
                 hidden_act: str = "gelu",
